...
# Używamy formatu iso8601 dla daty (bez spacji) i tabulatora jako separatora dla bezpieczeństwa.
while IFS=
...
echo ""
echo "Czyszczenie gałęzi zakończone."\t' read -r commit_date_iso branch_name; do
